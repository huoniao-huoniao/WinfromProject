...
namespace Device.controlUnit.Transmission
{
    public class DeviceMasterSlave
    {
        ...
        public async Task<double> ReadHoldingRegisters(DeviceTypeEnum dataType)
        {
            try
            {
        ...
        public void WriteHoldingRegisters(DeviceTypeEnum dataType,double result)
        {
            try
            {
                if (SlaveDevices != null)
                {
                    ...
                    SlaveDeviceSerial.WriteSingleRegister(slave.Slave, (ushort)(slave.Address + 1), intValues[0]);
                }
            }
    ...
    public class SlaveDevice
    {
        ...
        public DeviceTypeEnum DataType { get; set; } //温度 压力 流量
    }
